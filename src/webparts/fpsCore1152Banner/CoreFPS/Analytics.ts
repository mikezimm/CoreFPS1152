...
export function saveViewAnalytics( Title: string, Result: string, parentProps: IFpsCore1152BannerProps, analyticsWasExecuted: boolean, performanceObj: ILoadPerformance) : boolean {
